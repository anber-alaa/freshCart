    ...
    return (
        <>
            ...
            <div className="preloader__text">
                <p className="preloader__msg text-green-700"><span className='font-semibold text-green-700'>FreshCart</span> is loading..</p>
                <p className="preloader__msg preloader__msg--last text-green-700">This is taking long. Something’s wrong.</p>
            </div>
            </div>
        </>
    )
