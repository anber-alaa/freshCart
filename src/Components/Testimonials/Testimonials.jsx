...
const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Great store! Prices are reasonable, products are authentic, and delivery is fast and reliable!</p>
...
export default function Testimonials() {
    ...
    return (
    <>
    <h2 className="text-3xl text-secondaryColor text-center font-bold mb-3">
        Our Clients
    </h2>
